...
package laine.com.timepicker.third.spinnerwheel;
...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, getStyleableArryId("AbstractWheelView"), defStyle, 0);
        mItemsDimmedAlpha = a.getInt(getStyleId("AbstractWheelView_itemsDimmedAlpha"), DEF_ITEMS_DIMMED_ALPHA);
        mSelectionDividerActiveAlpha = a.getInt(getStyleId("AbstractWheelView_selectionDividerActiveAlpha"), DEF_SELECTION_DIVIDER_ACTIVE_ALPHA);
        mSelectionDividerDimmedAlpha = a.getInt(getStyleId("AbstractWheelView_selectionDividerDimmedAlpha"), DEF_SELECTION_DIVIDER_DIMMED_ALPHA);
        mItemOffsetPercent = a.getInt(getStyleId("AbstractWheelView_itemOffsetPercent"), DEF_ITEM_OFFSET_PERCENT);
        mItemsPadding = a.getDimensionPixelSize(getStyleId("AbstractWheelView_itemsPadding"), DEF_ITEM_PADDING);
        mSelectionDivider = a.getDrawable(getStyleId("AbstractWheelView_selectionDivider"));
        a.recycle();
    }

    private int getStyleId(String styleableName){
        Resources resources = getResources();
        int resId = resources.getIdentifier(styleableName, "styleable", getContext().getPackageName());
        return resId;
    }
