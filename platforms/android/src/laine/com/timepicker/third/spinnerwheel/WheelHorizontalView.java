...
//    }
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, getStyleableArryId("WheelHorizontalView"), defStyle, 0);
        mSelectionDividerWidth = a.getDimensionPixelSize(getStyleId("WheelHorizontalView_selectionDividerWidth"), DEF_SELECTION_DIVIDER_SIZE);
        a.recycle();
    }
