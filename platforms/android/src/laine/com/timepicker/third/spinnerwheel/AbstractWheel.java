...
//        mVisibleItems = a.getInt(getStyleId("AbstractWheelView_visibleItems"), DEF_VISIBLE_ITEMS);
//        mIsAllVisible = a.getBoolean(getStyleId("AbstractWheelView_isAllVisible"), false);
//        mIsCyclic = a.getBoolean(getStyleId("AbstractWheelView_isCyclic"), DEF_IS_CYCLIC);

        mVisibleItems = DEF_VISIBLE_ITEMS;
        mIsAllVisible = false;
        mIsCyclic =  DEF_IS_CYCLIC;
